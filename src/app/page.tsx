...
function Article({ article }: { article: ArtProps }) {
  return (
    <Card as="article">
      ...
      <Container className="my-28">
        <div className="flex flex-col gap-10 md:flex-row md:gap-4">
          <div className="pr-6 md:w-[60%]">
            ...
            <p className="my-4">
              As a seasoned product leader, I bring more than a decade of
              expertise to the stage, sharing insights on driving growth and
              navigating the ever-evolving tech landscape. My dynamic speaking
              engagements go beyond conventional presentations; they ignite
              inspiration, provoke thought, and leave a lasting impact on
              audiences.
            </p>
            <button className="">
